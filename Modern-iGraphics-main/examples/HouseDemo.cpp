...
double roof_x[] = {300, 400, 500,500,400,300};
double roof_y[] = {750, 830, 750,650,600,650};
...
int sun_x = 450, sun_y = 730, sun_r = 25;
...
void iDraw()
{
    ...
    iFilledRectangle(0, 0, 800, 1000);

    iSetColor(0, 255, 0);
    iFilledPolygon(roof_x, roof_y, 6);

    iSetColor(255, 0, 0);
    iFilledRectangle(350, 400, 100, 200);
    ...
    iSetColor(255, 255, 0);
    iFilledCircle(350, 730, 25);

     iSetColor(0, 0, 255);
    iFilledRectangle(325, 670, 150, 10);
...
int main(int argc, char *argv[])
{
    ...
    iInitialize(SCREEN_WIDTH, SCREEN_HEIGHT, "Diganta & Prottoy");
    return 0;
}
